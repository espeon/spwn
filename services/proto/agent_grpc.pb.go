...
const (
	...
	HostAgent_GetVmMetrics_FullMethodName    = "/agent.HostAgent/GetVmMetrics"
)
...
type HostAgentClient interface {
	...
	// Returns recent metric samples from the in-memory ring buffer.
	// If vm_id is empty, returns the latest sample for every running VM.
	GetVmMetrics(ctx context.Context, in *GetVmMetricsRequest, opts ...grpc.CallOption) (*VmMetricsResponse, error)
}
...
func (c *hostAgentClient) GetVmMetrics(ctx context.Context, in *GetVmMetricsRequest, opts ...grpc.CallOption) (*VmMetricsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VmMetricsResponse)
	err := c.cc.Invoke(ctx, HostAgent_GetVmMetrics_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HostAgentServer interface {
	...
	// Returns recent metric samples from the in-memory ring buffer.
	// If vm_id is empty, returns the latest sample for every running VM.
	GetVmMetrics(context.Context, *GetVmMetricsRequest) (*VmMetricsResponse, error)
...
func (UnimplementedHostAgentServer) GetVmMetrics(context.Context, *GetVmMetricsRequest) (*VmMetricsResponse, error) {
...
func _HostAgent_GetVmMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetVmMetricsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HostAgentServer).GetVmMetrics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HostAgent_GetVmMetrics_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HostAgentServer).GetVmMetrics(ctx, req.(*GetVmMetricsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HostAgent_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _HostAgent_GetVmMetrics_Handler,
		},
	},

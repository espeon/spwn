export type VmStatus = 'stopped' | 'starting' | 'running' | 'stopping' | 'snapshotting' | 'error'
...
export function signup(email: string, password: string, inviteCode: string): Promise<void> {
